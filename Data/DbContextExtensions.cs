    ...
    public static class DbContextExtensions
    {
        ...
        public static void EnsureSeeded(this ApplicationContext context)
        {
            if (UserManager.FindByEmailAsync("rhinoseros@mail.ru").GetAwaiter().GetResult() == null)
            {
                ...
                AddColorsFeaturesAndStorage(context);
                AddOperatingSystemsAndBrands(context);
                AddProducts(context);
            }
        }

        private static void AddColorsFeaturesAndStorage(ApplicationContext context)
        {
            if (context.Colors.Any() == false)
            {
                var Colors = new List<string>() { "Black", "White", "Gold", "Silver", "Grey", "Spacegrey", "Red", "Pink" };

                Colors.ForEach(c => context.Add(new Color
                {
                    Name = c
                }));
        ...
        private static void AddOperatingSystemsAndBrands(ApplicationContext context)
        {
                ...
                var products = new List<Product>()
        {
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Black"),
              ...
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Gold"),
                Storage = context.Storage.Single(s => s.Capacity == 32),
                Price = 319M
              },
              new ProductVariant
          ...
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "White"),
              ...
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Silver"),
                Storage = context.Storage.Single(s => s.Capacity == 8),
                Price = 159M
              },
              new ProductVariant
          ...
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Grey"),
              ...
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Spacegrey"),
                Storage = context.Storage.Single(s => s.Capacity == 4),
                Price = 99M
              },
              new ProductVariant
          ...
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              ...
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Red"),
                Storage = context.Storage.Single(s => s.Capacity == 16),
                Price = 499M
              },
              new ProductVariant
              ...
              new ProductVariant
              {
                Color = context.Colors.Single(c => c.Name == "Pink"),
                Storage = context.Storage.Single(s => s.Capacity == 16),
                Price = 499M
              },
              new ProductVariant
